...
describe '/api/v2/auth functionality test' do
  ...
  let!(:create_permissions) do
    ...
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'get', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'head', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'post', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'put', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'patch', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'delete', priority: 1, path: 'not_in_the_rules_path')
    Permission.create(role: 'member', action: 'ACCEPT', req_method: 'get', priority: 2, path: '/api/v2/resource/users/me')
  end
  ...
  describe 'testing rbac workability' do
    ...
    context 'with cookies' do
      ...
      context 'enough permissions' do
        it 'allowes access with for user with valid cookies, req_method, role and path' do
          do_create_session_request_adm
    ...
    context 'with api_keys' do
      context 'with valid api key headers' do
        context 'enough permissions' do
          it 'allowes access with for api key owner for valid req_method, owner role and path' do
